    ...
    <nav className="fixed top-0 left-0 w-full z-[100] border-b border-white/10 backdrop-blur-md bg-black/30">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="/mechanical-portfolio/resume.pdf" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-white/5 border border-white/10 rounded-full text-xs font-bold font-orbitron hover:bg-neon hover:text-black transition-all">
            RESUME
          </a>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden absolute top-16 left-0 w-full bg-black/98 border-b border-neon/20 p-4 flex flex-col gap-3 backdrop-blur-xl animate-in fade-in slide-in-from-top-2 duration-300">
          ...
          <a href="/mechanical-portfolio/resume.pdf" target="_blank" rel="noopener noreferrer" className="w-full flex items-center justify-center px-4 py-3 bg-neon/10 border border-neon text-neon font-bold font-orbitron rounded-lg hover:bg-neon hover:text-black transition-all">
            DOWNLOAD RESUME
          </a>
        </div>
      )}
